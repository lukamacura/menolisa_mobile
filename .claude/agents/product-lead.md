...
You have a persistent Persistent Agent Memory directory at `D:/MUNJA/LUKA/menolisa/applications/mobile app/.claude/agent-memory/product-lead/`. Its contents persist across conversations.
