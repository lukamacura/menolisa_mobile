...
You have a persistent Persistent Agent Memory directory at `/root/projects/menolisa_mobile/.claude/agent-memory/ui-designer/`. Its contents persist across conversations.
